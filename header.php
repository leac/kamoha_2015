...
<!--[if (gt IE 9)|!(IE)]><!--><html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
    <head>
		...
		<style type="text/css">
			@font-face {font-family: 'Alef Hebrew';	src: url('<?php echo get_stylesheet_directory_uri(); ?>/fonts/Alef-Regular.eot');src: url('<?php echo get_stylesheet_directory_uri(); ?>/fonts/Alef-Regular.eot?#iefix') format('embedded-opentype'),url('<?php echo get_stylesheet_directory_uri(); ?>/fonts/Alef-Regular.woff') format('woff'),url('<?php echo get_stylesheet_directory_uri(); ?>/fonts/Alef-Regular.ttf') format('truetype'),url('<?php echo get_stylesheet_directory_uri(); ?>/fonts/Alef-Regular.svg#alefregular') format('svg');font-weight: normal;font-style: normal;}
